...
- Read the caller's authoritative scope mode, diff base, reviewed-head identity, base SHA, commit range, commit log, diff, changed-file list, and any supplied PR or issue context
