...
> **Template notice:** This is a template file. Replace all `[INSERT ...]` placeholders
> before publishing. Remove this notice once the file reflects your project's actual policy.
...
If your project uses GitHub's private vulnerability reporting feature, you may also use
...
1. The reporter notifies the maintainers privately and provides sufficient detail to reproduce the issue.
