...
description: "Regenerates docs/tasks/BACKLOG.md from deferred observations and section registry. Called by /lp-harness-build, /lp-commit, and /lp-triage."
---
...
```
/lp-regenerate-backlog              → regenerate backlog (no staging)
/lp-regenerate-backlog --stage      → regenerate and git add (used by /lp-harness-build)
```
