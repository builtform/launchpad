...
description: Resolves review findings in .harness/todos/ by spawning parallel lp-harness-todo-resolver agents (max 5 concurrent).
---
...
- This mirrors Phase 4's lp-pr-comment-resolver Step 4 pattern
