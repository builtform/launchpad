...
- Fallback: if `/lp-learn` fails, run `LP_COMPOUND_AUTONOMOUS=1 bash ${CLAUDE_PLUGIN_ROOT}/bin/compound/compound-learning.sh` (basic extraction — autonomous-mode opt-in required)
