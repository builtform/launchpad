...
- **Communicate respectfully.** Use clear, considerate language in all interactions — issues, pull requests, discussions, and any other project space.
- **Give and receive feedback constructively.** Focus on ideas and code, offer specific and actionable suggestions, and accept feedback with an open mind.
...
Project maintainers are responsible for clarifying community standards and for taking fair, consistent action in response to conduct that falls outside these expectations. Maintainers have the right to edit, remove, or reject contributions, comments, or other participation that does not align with this Code of Conduct, and will communicate reasons for moderation decisions when appropriate.

## Scope

This Code of Conduct applies to all project spaces, including repositories, issue trackers, discussion forums, and mailing lists. It also applies when individuals are representing the project in public settings such as conferences, community events, or social media.
