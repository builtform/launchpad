...
is_excluded() {
  ...
  case "$file" in
    docs/reports/launchpad_reports/*|docs/plans/launchpad_plans/*|docs/handoffs/launchpad_handoffs/*|docs/maintainers/*|docs/releases/*|docs/architecture/SCAFFOLD_*.md) return 0 ;;
  esac
