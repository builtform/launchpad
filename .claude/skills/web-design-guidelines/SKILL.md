...
<!-- ported-from: https://github.com/vercel-labs/web-interface-guidelines
     original-authors: Vercel Design Team (John Phamous, et al.)
     port-date: 2026-03-14
     license: MIT
     consolidation-note: Based on AGENTS.md (MUST/SHOULD/NEVER format) + Design section from README. Removed Vercel-specific copywriting. Kept all framework-agnostic and React/Next.js rules. -->

Concise rules for building accessible, fast, delightful UIs. Use MUST/SHOULD/NEVER to guide decisions.

This skill provides **engineering compliance** rules. For creative direction (aesthetics, typography pairing, color philosophy, AI slop detection), see the `frontend-design` skill.
...
- MUST: Use `...` character (not `...` three periods)
...
- MUST: Non-breaking spaces: `10&nbsp;MB`, brand names
...
- SHOULD: Text anti-aliasing during transforms — animate wrapper, not text node
