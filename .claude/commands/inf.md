...
```bash
LP_COMPOUND_AUTONOMOUS=1 ./scripts/compound/build.sh $ARGUMENTS [SECTION_SPEC_PATH]
```
...
```bash
LP_COMPOUND_AUTONOMOUS=1 ./scripts/compound/build.sh $ARGUMENTS docs/tasks/sections/<section-name>.md
```
