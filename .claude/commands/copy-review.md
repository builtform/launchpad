...
```
/copy-review              → dispatch copy review agents (if configured)
```
...
- Return structured findings to the calling step (Step 2c of `/harness:plan`)
...
- BuiltForm adds `copy-auditor` in Phase 11
- Other projects add their domain-specific copy review agents
