...
```
/copy                    → read copy from current section spec
/copy [section-name]     → read copy from named section spec
```
...
The extension point is in the section spec's copy section — downstream `/shape-section` commands invoke copy skills to populate it.
