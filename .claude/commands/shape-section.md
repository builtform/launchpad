...
Shaping is the bridge between high-level product definition and implementation planning. After a section is shaped, it has enough detail for `/pnf` to create a concrete implementation plan.
